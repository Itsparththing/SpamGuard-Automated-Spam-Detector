...
This program sends a POST request to a machine learning model deployed on Azure Container Instances (ACI) at a specified URL. The request includes input data (data) in JSON format.
